...
class HousingImageAdapter(private var itemList: ArrayList<HousingImageModel>, private val itemClickListener: HousingImageItemClickListener): RecyclerView.Adapter<HousingImageAdapter.ItemViewHolder>() {
