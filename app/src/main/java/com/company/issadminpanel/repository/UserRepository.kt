...
class UserRepository {
    fun getUserList(userType: String?, liveData: MutableLiveData<ArrayList<UserModel>?>) {
        Firebase.database.reference.child("users").orderByChild("user_type").equalTo(userType).addValueEventListener(object : ValueEventListener {
